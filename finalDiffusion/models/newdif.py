...
# These are your steering matrix generators
...
# Differentiable version of the RD map conversion
def create_rd_map_differentiable(IQ_map):
    ...
    # Compute the RD map in a differentiable manner (no detach or cpu conversion)
